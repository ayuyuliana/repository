...
class RepositoryController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('repository.index')->with('success', 'Data repository berhasil diperbaharui.');
    }
    ...
    public function destroy(string $id)
    {
        ...
        if ($repository) {
            $repository->delete();
            return redirect()->route('repository.index')->with('succes', 'Data repository berhasil dihapus');
        } else {
